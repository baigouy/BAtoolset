...
# logger
# from batools.figure import fig_tools
from batools.figure.alignment import alignLeft, setToWidth2, updateBoudingRect, packY, packX, _brute_force_find_height, \
    _brute_force_find_width
from batools.figure.fig_tools import get_master_bounds2, get_common_scaling_factor
...
class Column(Rect2D):
    ...
    def __truediv__(self, other):
        # from batools.figure.panel import Panel
