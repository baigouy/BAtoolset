...
from batools.figure.row import Row  # KEEP Really required to avoid circular imports
logger = TA_logger()
...
class col(Rect2D):
    ...
    def __add__(self, other):
        from batools.figure.row import Row  # KEEP Really required to avoid circular imports # TODO is that still true ?
...
if __name__ == '__main__':
    ...
    result = img1 | img2 # fix so that this works ???
