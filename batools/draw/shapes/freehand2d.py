...
class Freehand2D(Polygon2D):
    ...
    def __init__(self, *args, coords_as_list=None, color=0xFFFFFF, opacity=1., stroke=0.65, line_style=None, theta=0, invert_coords=False, fill_color=None,__version__=1.0, **kwargs):
        ...
        if len(args) > 0:
            ...
            # elif isinstance(args[0],QPolygonF):
            #
            else:
