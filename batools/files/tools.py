...
"""
from batools.lists.tools import find_first_index, flatten_list
from batools.strings.tools import is_string_a_list_string, reload_string_list
...
from batools.utils.loadlist import loadlist
from batools.colors.colorgen import get_unique_random_color_int24
import os
...
if __name__ == '__main__':
    ...
    import importlib
    print(importlib.import_module("batools.files.tools")) #<module 'batools.files.tools' from '/home/aigouy/mon_prog/Python/epyseg_pkg/epyseg/files/tools.py'>
