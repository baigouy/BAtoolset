...
from batools.pyqt.tools import getCtrlModifier
...
from batools.dialogs.opensave import saveFileDialog
from batools.draw.widgets.vectorial import VectorialDrawPane
from qtpy.QtWidgets import QMenu
from qtpy import QtCore, QtGui, QtWidgets
from batools.img import toQimage, Img, get_white_bounds, RGB_to_int24, is_binary, auto_scale, save_as_tiff
...
from batools.ta.selections.selection import get_colors_drawn_over, convert_selection_color_to_coords
...
class Createpaintwidget(QWidget):
    ...
    def _draw_on_image(self, image_to_be_drawn, event, zoom_corrected_pos, erase_color=None):
        ...
        try:
            ...
            if event.buttons() == QtCore.Qt.LeftButton and not (event.modifiers() == getCtrlModifier() or event.modifiers() ==QtCore.Qt.ShiftModifier):
