...
# the cost to keep this is too high as it forces the import of tf which is not good
...
if __name__ == '__main__':
    ...
    if True:
        ...
        from batools.img import save_as_tiff, Img, elastic_deform, invert
        from batools.files.tools import smart_name_parser
        from batools.utils.loadlist import list_processor, loadlist
    ...
    if True:
        ''' MT VERSION BELOW '''
        from functools import partial
        from batools.img import save_as_tiff, Img
        from batools.files.tools import smart_name_parser
        from batools.utils.loadlist import list_processor, loadlist
