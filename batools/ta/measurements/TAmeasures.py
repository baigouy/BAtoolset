...
from batools.img import Img, pad_border_xy
from skimage.measure import label, regionprops
import numpy as np
import traceback
from batools.ta.measurements.nematic import compute_stretch_nematic
from batools.tools.early_stopper_class import early_stop
from batools.utils.loadlist import loadlist
from batools.ta.database.sql import TAsql, get_property
from batools.ta.segmentation.neo_wshed import wshed
# from epyseg.ta.clones.clone_fuser import distance_between_points
from batools.ta.measurements.nematic_measurements import compute_polarity_nematic
from batools.ta.measurements.measurements3D.get_point_on_surface_if_centroid_is_bad import point_on_surface
from batools.ta.measurements.measurements3D.measures3D import compute_3D_surfacearea, perimeter_3D
from batools.ta.measurements.measurements3D.triangulate import triangulate
from batools.ta.tracking.rapid_detection_of_vertices import detect_vertices_and_bonds, cantor_color_bonds, neighbors8
from timeit import default_timer as timer
from batools.files.tools import smart_name_parser
from batools.ta.tracking.tracking_error_detector_and_fixer import get_border_cells, get_border_cells_plus_one, \
    get_cells_and_their_neighbors_from_image
from batools.ta.utils.rps_tools import pavlidis, compute_distance_between_consecutive_points
import math
    ...
    for bond in rps_bonds:
        ...
        if len(vertices_ids) > 2:
            try:
                ...
                traceback.print_exc()
                if __DEBUG__:
                    print('error correcting the number of vertices of the bond --> please report this to benoit.aigouy@gmail.com')
                logger.error(
                    'error correcting the number of vertices of the bond --> please report this to benoit.aigouy@gmail.com')
        ...
        if vertex.area >= 2:
            ...
            for lst in pairs:
                ...
                if len(cells_around_bond) > 2:
                    print('pairs of vertices have too many cells in common, please report error to benoit.aigouy@gmail.com')
