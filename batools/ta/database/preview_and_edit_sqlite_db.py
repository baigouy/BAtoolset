...
from batools.ta.database.sql_column_name_dialog import SQL_column_name_and_type
from batools.utils.loadlist import loadlist, smart_TA_list
from batools.ta.database.my_qt_table import MyTableWidget
from batools.ta.database.sql import TAsql, get_properties_master_db, \
